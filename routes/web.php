...
Route::controller(BasicController::class)->group(function () {
    ...
    Route::middleware(['authCheck'])->group(function () {
        ...
        Route::get('/client/project/payment/editRefund/{id}', 'payment_RefundEdit');
        ...
        Route::get('/client/project/payment/editDispute/{id}', 'payment_Edit_Dispute');
        ...
        Route::get('/forms/csv_uploads_sheetinvoicingClientFirstSMM', 'csv_sheetpaymentsClientFirstSMM');
        ...
        Route::get('/forms/csv_uploads_sheetinvoicingcreative', 'csv_sheetpaymentscreative');
