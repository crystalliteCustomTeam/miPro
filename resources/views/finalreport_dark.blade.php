    ...
    <div class="br-section-wrapper">
        <div class="row">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-3" style="text-align: right">
                            <label style=" color: white; font-weight: bold;  text-align: right; font-size: 20px;">Number of Days Left:</label>
                            <label id="remainingdays" style="background-color: #FF9933; color: black; font-weight: bold;  text-align: right; font-size: 20px;">--</label>
                    ...
                    <div class="col-12 mg-b-15">
                        <div class="row">
                            ...
                            <div class="col-3 mt-3">
                                ...
                                <input type="date" name="date" required class="form-control-dark wd-350" placeholder="  1234" style="height: 50px;" id="dateforagent">
                            </div>
            ...
            <div class="col-12">
                <br><br>
                <div class="row">
                    <div class="col-10"><h4 style=" color: white; font-weight: bold; ">Refund & Disputes Report:</h4></div>
                    <div class="col-2">
                    </div>
                </div>
            </div>
            ...
            <div class="col-4" >
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-10"><h4 style=" color: white; font-weight: bold; ">Dispute & Refund % Chart:</h4></div>
                        <div class="col-2"></div>
                    </div>
            ...
            <div class="col-4">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-10" id="hideornot"><h4 style="color: white; font-weight: bold; ">Target Chasing Graph:</h4></div>
                        <div class="col-2"></div>
                    </div>
            ...
            <div class="col-4">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-10"><h4 style=" color: white; font-weight: bold; ">Sales Distribution Chart:</h4></div>
                        <div class="col-2"></div>
                    </div>
            ...
            <div class="col-12 mg-b-15">
                <br><br>
                <div >
                    <h4 style=" color: white; font-weight: bold; "> Team Target Monitoring:</h4>
                    <table id="" class=" ">
                        <thead>
                          <tr role="row">
                    ...
                    success:((Response)=>{
                        console.log(Response);
                            ...
                            employees11.forEach(employee121 => {
                                ...
                                heading.style = ' color: white; font-weight: bold;';
                                ...
                                table.className = 'table-dark-wrapper table-hover';
                            ...
                            branddata.forEach(branddatas => {
                                ...
                                brandtodayfront.style.color = 'white';
                                ...
                                brandtodayback.style.color = 'white';
                                ...
                                brandtodayupsells.style.color = 'white';
                                ...
                                brandtodayremaining.style.color = 'white';
                                ...
                                brandtodayrenewals.style.color = 'white';
