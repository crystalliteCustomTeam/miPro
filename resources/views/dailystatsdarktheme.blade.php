      ...
      <div class="col-12">
          <div class="row">
                  ...
                  <form action="/payment/daily/{id?}" method="get">
                          ...
                          <div class="col-3 mt-3">
                              ...
                              @if(isset($_GET['startdate']))
                                  ...
                                  <input type="Date" name="startdate"  class="form-control-dark wd-300" onchange="createURL(this.value)" value="{{ $_GET['startdate'] }}" style="height: 50px;" placeholder="  Enter name">
                              @else
              ...
              <div class="col-8">
                  <div class="col-12">
                      <div class="row">
                          <div class="col-12"><h4 style=" color: white; font-weight: bold;">Brand Wise Daily Payment:</h4></div>
                          {{-- <div class="col-2">
                          </div> --}}
                      </div>
                  </div>
                      ...
                      <tbody id="brandtodaypayment">
                          ...
                          @foreach ($branddata as $item)
                              @if ($item['front'] != 0 || $item['back'] != 0)
                                  <tr>
                                      <td  style="width: 253px;  color: white; font-weight: bold; border-top: none; border-right: none; border-left: 1px solid white; border-bottom: 1px dotted #4169E1; text-align: left;">{{$item['name']}}</td>
                                      <td  style="width: 193px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['front'] != 0) ${{$item['front']}} @endif</td>
                                      <td  style="width: 193px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['back'] != 0) ${{$item['back']}} @endif</td>
                                      <td  style="width: 193px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['brandupsell'] != 0) ${{$item['brandupsell']}} @endif</td>
                                      <td  style="width: 193px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['brandremaining'] != 0) ${{$item['brandremaining']}} @endif</td>
                                      <td  style="width: 203px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['sumofallrenewals'] != 0) ${{$item['sumofallrenewals']}} @endif</td>
                                      <td  style="width: 193px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #4169E1; text-align: center;">@if($item['all'] != 0) ${{$item['all']}} @endif</td>
                                  </tr>
                              @endif
                              @php
                              $frontsum += $item['front'];
              ...
              <div class="col-4">
                  <div class="col-12">
                      <div class="row">
                          <div class="col-10"><h4 style=" color: white; font-weight: bold; ">Daily Individual Stats:</h4></div>
                          <div class="col-2">
                          </div>
                      </div>
                  </div>
                      ...
                      <tbody id="empdailypayment">
                          ...
                          @foreach ($employees as $item1)
                              @if ($item1['allrevenue'] != 0 )
                                  <tr>
                                      <td  style="width: 243px;  color: white; font-weight: bold; border-top: none; border-right: none; border-left: 1px solid white; border-bottom: 1px dotted #FF9933; text-align: left;">{{$item1['name']}}</td>
                                      <td  style="width: 183px;  color: white; border-top: none; border-right: none; border-left: none; border-bottom: 1px dotted #FF9933; text-align: center;">@if($item1['allrevenue'] != 0) ${{$item1['allrevenue']}} @endif</td>
                                      <td  style="width: 183px;  color: white; border-top: none; border-right: 1px solid white; border-left: 1px solid white; border-bottom: 1px dotted #FF9933; text-align: center;">@if($item1['allrevenue'] != 0) ${{$item1['allrevenue']}} @endif</td>
                                  </tr>
                              @endif
                              @php
