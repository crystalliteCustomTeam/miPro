  ...
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-3">
          <label for="">Illustration Team</label>
          <input type="text" name="Illustration_Team" required class="form-control">
        </div>
        <div class="col-3">
            <label for="">Illustration Evidence(if any issue) </label>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of Publishing</label><br>
          ...
          <div class="col-3">
            <label for="">Book Cover Status</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of 3 Month Marketing</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of 6 Month Marketing</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of Design</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of Development</label><br>
          ...
          <div class="col-3">
            <label for=""> Web Development </label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of SEO</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of SMM</label><br>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for="">Status of SEO Writing</label><br>
        ...
        <div class="col-3">
            <label for="">Issue in SEO Content </label><br>
        ...
        <div class="col-3">
          <label for="">SEO Content Writer</label>
          <input type="text" name="SEO" required class="form-control">
        </div>
        <div class="col-3">
            <label for="">SEO Content  Evidence(if any issue) </label>
...
<div class="br-pagebody">
  <div class="br-section-wrapper">
   <form action="#" method="POST">
    ...
    <div class="row">
        <div class="col-3">
            <label for=""> Client Satisfaction Level </label><br>
            <input type="radio" id="dispute" name="status" value="dispute">
        ...
        <div class="col-3">
          ...
          <div class="col-3">
            <label for=""> Refund & Dispute Expected </label><br>
            <input type="radio" id="dispute" name="status" value="dispute">
