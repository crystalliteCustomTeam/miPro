    ...
    <div class="br-pagebody">
        <form action="/project/report/{id?}" method="get">
            ...
            <div class="col-3 mt-3">
                ...
                <label for="" style="font-weight:bold;">Start Date:</label><br>
                @if(isset($_GET['startdate']))
                      {{-- <input onchange="createURL(this.value)" value="{{ $_GET['startdate'] }}" class="form-control" type="Date" name="startdate"> --}}
                      <input onchange="createURL(this.value)"  type="Date" name="startdate" value="{{ $_GET['startdate'] }}"  class="form-control-dark wd-350"  required style="height: 50px;" >
                @else
                 {{-- <input onchange="createURL(this.value)"  class="form-control" type="Date" name="startdate"> --}}
                 <input onchange="createURL(this.value)"  type="Date" name="startdate"  class="form-control-dark wd-350"  required style="height: 50px;" >
                @endif
            ...
            <div class="col-3 mt-3">
                ...
                @if(isset($_GET['enddate']))
                      ...
                      <input onchange="createURL(this.value)"  type="Date" name="enddate" value="{{ $_GET['enddate'] }}"  class="form-control-dark wd-350"  required style="height: 50px;" >
                @else
                    {{-- <input onchange="createURL1(this.value)"    class="form-control" type="Date" name="enddate"> --}}
                    <input onchange="createURL(this.value)"  type="Date" name="enddate"  class="form-control-dark wd-350"  required style="height: 50px;" >
                @endif
