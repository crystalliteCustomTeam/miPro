            ...
            <table id="datatable1" class="table-dark-wrapper table-hover">
                <thead>
                  <tr role="row">
                    ...
                    <th class="wd-15p sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" style="width: 203px;" aria-label="Last name: activate to sort column ascending">Complete</th>
                ...
                <tbody>
                    @if ($user_id == 0)
                        ...
                        <a href="#" onclick="myConfirm('{{ $department->id }}')" class=" btn-icon rounded-circle mg-r-5">
                        <div><img src="https://cdn-icons-png.flaticon.com/16/16750/16750043.png" alt=""></div>
                        </td>
                    ...
                    @elseif ($user_id == 1)
                        ...
                        <a href="#" onclick="myConfirm('{{ $department->clientname->id }}')" class=" btn-icon rounded-circle mg-r-5">
                        <div><img src="https://cdn-icons-png.flaticon.com/16/16750/16750043.png" alt=""></div>
                        </td>
                    ...
                    <script>
                        function myConfirm(id){
                            Swal.fire({
                            title: "Mark This Client Completed?",
                            ...
                            if (result.isConfirmed) {
                                window.location.href = "/client/completed/" + id;
                                Swal.fire({
                                title: "Completed!",
                                text: "Client has been marked completed.",
                                icon: "success"
                                });
                            }});
