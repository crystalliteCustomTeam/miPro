...
@section($theme == 1 ? 'maincontent1' : 'maincontent')
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagetitle">
          ...
          <div>
            <h4>Set Up Client Projects(CSV)</h4>
            <p class="mg-b-0">Projects</p>
          </div>
        </div><!-- d-flex -->

        <div class="br-pagebody">
          <div class="br-section-wrapper">
           <form action="/forms/csv_uploads_upload/process" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-6  mt-3">
                    ...
                    @if ($theme == 1)
                    <input type="file" name="projectfile" class="form-control-dark wd-600" required style="height: 50px;">
                    @else
