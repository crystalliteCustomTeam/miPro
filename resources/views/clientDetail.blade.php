                    ...
                    <div class="media-body mg-l-20">
                      ...
                      <div class="media-footer">
                        <div class=" ">
                            ...
                            <a href="/forms/qaform/client/{{ $client[0]->id }}" class="btn btn-sm  btn-warning" style="color:white;border-radius: 15px;"><img src="https://cdn-icons-png.flaticon.com/24/4381/4381727.png" style="filter: invert(1); margin-right:10px" alt="" title="" class="img-small"> C QA</a>
                            <a href="/forms/qaform/{{  $project->id }}" class="btn btn-sm  btn-warning" style="color:white;border-radius: 15px;"><img src="https://cdn-icons-png.flaticon.com/24/4381/4381727.png" style="filter: invert(1); margin-right:10px" alt="" title="" class="img-small"> P QA</a>
