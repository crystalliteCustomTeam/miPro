            ...
            <table id="datatable1" class="table-dark-wrapper table-hover">
                <thead>
                  <tr role="row">
                    ...
                    <th class="wd-10p sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" style="width: 203px;" aria-label="Salary: activate to sort column ascending">Paid</th>
                    ...
                    <tr role="row" class="odd">
                        @if ($item->remainingStatus != 'Unlinked Payments')
                            ...
                            <td>
                                ...
                                <div class="btn-group">
                                    @if (!isset($item->paymentclientName->name))
                                    {{-- <a href="/client/editnewemail/{{$item->id}}" class="btn btn-info">Edit Client</a> --}}
