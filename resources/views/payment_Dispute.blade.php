                ...
                <form action="/client/project/payment/Dispute/process" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            ...
                            @if ($theme == 1)
                            <input type="date"  required name="disputedate" class="form-control-dark wd-600" style="height: 50px;">
                            @else
                        ...
                        <div class="col-6 mt-3">
                            ...
                            @if ($theme == 1)
                            <input type="text" class="form-control-dark wd-600" placeholder="  Enter Name" onkeypress="return /[0-9]/i.test(event.key)" name="clientpaid" required style="height: 50px;" value="{{$client_payment[0]->Paid}}">
                            @else
                        ...
                        <div class="col-6 mt-3">
                            ...
                            @if ($theme == 1)
                            <input type="text" class="form-control-dark wd-600" placeholder="  Enter Name" onkeypress="return /[0-9]/i.test(event.key)" name="disputefee" required style="height: 50px;">
                            @else
