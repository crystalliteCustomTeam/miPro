    ...
    <div class="row no-gutters flex-row-reverse ht-100v">
      <div class="col-md-6 bg-gray-200 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-250 wd-xl-350 mg-y-30">
          ...
          <div class="form-group">
            <input type="email" class="form-control" name="ClientEmail" placeholder="Enter your Email" required>
          </div><!-- form-group -->
          <div class="form-group">
            <input type="text" class="form-control" name="ClientUserName" placeholder="Enter your username" required>
          </div><!-- form-group -->
          <div class="form-group">
            <input type="password" class="form-control" name="ClientPassword" placeholder="Enter your password" required>
            <a href="" class="tx-12 d-block mg-t-10">Forgot password?</a>
          </div><!-- form-group -->
          <button type="submit" class="btn btn-success btn-block">Sign In</button>

          <div class="mg-t-60 tx-center">Not yet a member? <a href="/">Sign Up</a></div>
        </form>
        </div><!-- login-wrapper -->
      </div><!-- col -->
