    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
           <form action="/forms/csv_uploads/process" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-6  mt-3">
                    <label for="">Front Seller</label>
                    <select class="form-control select2"  name="frontseller" >
                ...
                <div class="col-6  mt-3">
                    ...
                    @if ($theme == 1)
                    <input type="file" name="file" class="form-control-dark wd-600" required style="height: 50px;">
                    @else
