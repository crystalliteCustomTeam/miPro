           ...
           <table id="datatable1" class="table-dark-wrapper table-hover">
              <thead>
                <tr role="row">
                  ...
                  <th class="wd-10p sorting" tabindex="0" aria-controls="datatable1" rowspan="1" colspan="1" style="width: 127px;" aria-label="Salary: activate to sort column ascending">Action</th>
