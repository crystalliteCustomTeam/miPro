    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">QA FORM ISSUES</span>
          </nav>
        </div><!-- br-pageheader -->
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
           <form action="/settings/qa_issues/Process" method="POST">
            @csrf
            <div class="row">
              ...
              <tbody>
                @foreach ($qa_issues as $qa_issue)
                  <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="/settings/delete_qa_issues/{{$qa_issue->id}}"><button class="btn btn-danger btn-sm"> <img src="https://cdn-icons-png.flaticon.com/16/8745/8745912.png" alt="" style="filter: invert(1);"> Delete</button></a>
                        </div>
                      </td>
                  </tr>
                @endforeach
