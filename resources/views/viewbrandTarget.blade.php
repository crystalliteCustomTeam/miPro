    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="#">Brand Target</a>
            <span class="breadcrumb-item active">Manage Brands</span>
          </nav>
        </div><!-- br-pageheader -->
           ...
           <table id="datatable1" class="table-dark table-hover">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  <td tabindex="0" class="sorting_1">{{ $brand->brandoftarget->name }}</td>
                  <td>{{ $brand->Year }}</td>
                  <td>{{ $brand->January }}</td>
                  ...
                  <td> <a href="/settarget/edit/{{$brand->id}}" class="btn btn-success">Edit</a> </td>
                </tr>
                @endforeach
