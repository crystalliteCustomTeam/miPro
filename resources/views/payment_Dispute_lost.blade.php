                ...
                <form action="/client/project/payment/Dispute/process/lost" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            @if ($theme == 1)
                    <textarea required name="description" placeholder="  Enter Description" class="form-control-dark wd-1000" id="" cols="30" rows="10"></textarea>
                    @else
                    ...
                    @endif
                          ...
                          <div class="col-12 mt-3">
                              ...
                              @if ($theme == 1)
                            <textarea required name="Description_of_issue" placeholder="  Enter Description" class="form-control-dark wd-1000" id="" cols="30" rows="10"></textarea>
                            @else
