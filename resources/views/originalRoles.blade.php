    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
          <div class="br-section-wrapper">
           <form action="/sales/originalroles/process" method="POST">
            @csrf
            <div class="row">
                ...
                <div class="col-6 mt-3">
                        ...
                        @if ($theme == 1)
                        <input type="text" name="name" class="form-control-dark wd-600" placeholder="  Enter Name" required style="height: 50px;">
                        @else
                ...
                <div class="col-12 mt-3">
                        ...
                        <select class="form-control select2" name="front[]" multiple="multiple">
                            @foreach ($employees as $brands)
                            <option value="{{ $brands->id }}">{{ $brands->name }}--
                                @foreach($brands->deparment($brands->id)  as $dm)
