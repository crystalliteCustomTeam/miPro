        ...
        <form action="/seo_kyc_form/process" method="POST">
            ...
            <div class="row">
                ...
                <select class="form-control select2"   required name="saleperson">
                    <option value="{{$frontSeller[0][0]->id}}" selected>{{$frontSeller[0][0]->email}}</option>
                </select>
...
@elseif ($frontSeller[1] == 'New Sale')
        <form action="/new_seo_kyc_form/process" method="POST">
            @csrf
            <input type="hidden" name="serviceType" id="seo" value="seo">
